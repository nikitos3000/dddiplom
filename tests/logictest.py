...
class TestSudokuGame(unittest.TestCase):
    ...
    def test_remove_numbers(self):
        ...
        # Проверяем, что оставшиеся числа не изменились
        for i in range(9):
            for j in range(9):
    ...
    def test_is_completed_correctly(self):
        ...
        invalid_board[0][0] = 1  # Создаем дублирование
